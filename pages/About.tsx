  ...
  return (
    <div className="bg-white min-h-screen">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <Reveal direction="left">
            <div className="mb-16">
              ...
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-none">Why Agencies <br/>Choose Exploge.</h2>
            </div>
          </Reveal>

          {/* Master Bento Grid */}
          <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 lg:gap-6 min-h-[700px]">
            
            {/* LARGE HERO CARD: The Mindset */}
            <Reveal direction="up" className="md:col-span-2 md:row-span-2">
              <SpotlightWrapper className="h-full">
                <div className="relative bg-zinc-50 h-full border border-black/5 rounded-md p-8 md:p-12 flex flex-col justify-between hover:border-primary/30 transition-all duration-500 shadow-sm hover:shadow-xl">
                  <div className="relative z-10">
                    <div className="w-12 h-12 bg-primary/10 text-primary flex items-center justify-center rounded-md mb-8 group-hover:scale-110 transition-transform duration-500">
                  ...
                  <div className="relative z-10 pt-12 flex items-center gap-4 text-[10px] font-bold mono uppercase tracking-widest text-secondary group-hover:text-primary transition-colors">
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.02] group-hover:opacity-[0.05] transition-opacity pointer-events-none">
                    <Icons.Cpu size={400} strokeWidth={0.5} />
                  </div>
                </div>
              </SpotlightWrapper>
            </Reveal>
            ...
            <Reveal direction="up" delay={0.1} className="md:col-span-2">
              <SpotlightWrapper className="h-full" spotlightColor="rgba(32,188,97,0.25)">
                <div className="relative bg-premium-dark h-full border border-white/5 rounded-md p-8 text-white flex items-center justify-between hover:shadow-[0_0_40px_rgba(32,188,97,0.15)] transition-all duration-500">
                  <div className="relative z-10">
                    <div className="text-6xl lg:text-7xl font-black text-primary mb-2 tracking-tighter group-hover:scale-105 transition-transform duration-500 origin-left">65%</div>
                  ...
                  <div className="relative z-10 hidden sm:block">
                    <div className="w-24 h-24 border-2 border-primary/20 rounded-full flex items-center justify-center animate-spin-slow">
                      <Icons.Zap className="w-10 h-10 text-primary" />
                    </div>
                  </div>
            ...
            <Reveal direction="up" delay={0.2} className="md:col-span-1">
              <SpotlightWrapper className="h-full">
                <div className="relative h-full bg-white border border-black/5 rounded-md p-8 hover:border-primary/20 transition-all duration-500 hover:-translate-y-1 hover:shadow-lg flex flex-col justify-between">
                  <div className="relative z-10">
      ...
      <section className="py-24 bg-gray-50 overflow-hidden relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-12 border-y border-black/10 py-16">
            ...
            <Reveal direction="up" delay={0.2} className="md:w-1/2">
          ...
          <div className="flex flex-col lg:flex-row gap-20 items-stretch">
            <div className="w-full lg:w-1/2">
              <Reveal direction="left">
                <div className="relative h-full">
                  ...
                  <div className="absolute -bottom-6 -right-6 bg-primary p-6 shadow-2xl border border-black/5 rounded-md">
                    <div className="text-white font-black uppercase text-2xl italic tracking-tighter">Haroon Taj</div>
                    <div className="text-white/70 font-bold uppercase text-[10px] tracking-[0.3em] mono">Founder & CEO</div>
                  </div>
                </div>
              </Reveal>
            </div>
            <div className="w-full lg:w-1/2 flex flex-col justify-center space-y-10">
              <Reveal direction="right">
                ...
                <h3 className="text-5xl md:text-6xl font-black uppercase tracking-tighter leading-[0.9] mb-8">"Most businesses are running on <span className="text-primary italic">hope</span> and spreadsheets. We engineer the cure."</h3>
                <div className="space-y-8 text-gray-500 leading-relaxed text-lg">
                  ...
                  <div className="pt-6 border-t border-black/5">
                    <p className="font-bold text-secondary italic text-2xl tracking-tighter">
      ...
      {/* Form Section */}
      <section id="contact" className="py-24 bg-premium-dark text-white relative overflow-hidden">
        <AmbientGroup variant="dark" />
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <Reveal direction="none">
                ...
                <h3 className="text-4xl sm:text-5xl font-black uppercase tracking-tighter mb-6">Direct Connection.</h3>
            ...
            <div className="bg-white p-8 md:p-12 border-t-8 border-primary relative overflow-hidden rounded-md">
              <div className="absolute top-0 left-0 w-full h-1 bg-primary/20"></div>
              {submitted ? (
                <div className="py-20 text-center animate-in fade-in zoom-in duration-500">
                  <div className="w-20 h-20 bg-primary/10 text-primary rounded-full flex items-center justify-center mx-auto mb-6">
                    <Icons.Check className="w-10 h-10" strokeWidth={2.5} />
                  </div>
                  <h4 className="text-secondary text-3xl font-black uppercase tracking-tighter mb-2">Message Sent</h4>
                  <p className="text-gray-500 uppercase font-bold text-xs tracking-widest">We will respond within 120 minutes.</p>
                </div>
              ) : (
