  ...
  return (
    <section className="py-24 md:py-32 bg-white overflow-hidden relative">
      <div className="container mx-auto px-6 relative">
        ...
        <div className="max-w-5xl mx-auto relative min-h-[400px] md:min-h-[600px] flex flex-col items-center justify-between">
          ...
          {/* MIDDLE: Action Row */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-12 w-full relative z-10 mb-12 md:mb-20">
