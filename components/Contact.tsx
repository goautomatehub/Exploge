...
export const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-premium-dark text-white overflow-hidden relative">
      <AmbientBlobs color="bg-primary" size="w-[300px] h-[300px] md:w-[500px] md:h-[500px]" className="-top-24 -right-24 md:-top-48 md:-right-48" opacity="opacity-[0.08]" animation="animate-blob" />
      <AmbientBlobs color="bg-primary" size="w-48 h-48 md:w-72 md:h-72" className="bottom-0 left-0" opacity="opacity-[0.05]" animation="animate-blob-slow" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          <div className="w-full lg:w-1/2 space-y-6 md:space-y-8">
            ...
            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-tighter">
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex items-center gap-4 group cursor-pointer">
                ...
                <span className="text-gray-300 text-sm md:text-base font-medium group-hover:text-white transition-colors">San Francisco & London</span>
              </div>
            </div>
          </div>
          
          <div className="w-full lg:w-1/2">
            <div className="bg-white p-6 md:p-10 relative rounded-md">
              {submitted ? (
                <div className="py-12 md:py-20 text-center animate-pulse">
